/*
	Creation d'une procedure stockée qui renvoie les requêtes en cours sur le serveur 
		ainsi que toutes les informations associées comme l’utilisateur exécutant la requête, la consommation CPU, les entrées/sorties 
		ou encore les requêtes elles-mêmes.
*/
USE master
GO
